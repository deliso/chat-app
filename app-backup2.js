...
function displayWelcomePage() { //Nombre alternativo
    ...
    //Pending refactoring
    function displayLocalStorage() { //Attribution: https://www.youtube.com/watch?v=LfeOLVGHiXI&t=607s //usar displayChatHistory
        let lsArr = [];

        for(let i=0;i<localStorage.length;i++) {
            lsArr.push(localStorage.key(i));  //Usar prefijo al guardar Local storage y solo recuperar los mensajes
